...
namespace Drupal\rest_module\Controller;
...
class RestController extends ControllerBase{
    public function rest() {
        // $url1 = Url::fromRoute('rest.entity.node.GET'); // This is 
        // $link1 = Link::fromTextAndUrl(t('Go to rest get page'), $url1);
        // $list[] = $link1;

        // $output['node/rest_api'] = [
        //     '#items' => $list,
        // ];
        // return $output;
